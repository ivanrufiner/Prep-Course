...
if (numero <= 1) return false // si numero es menor-igual que 1 return false
for (var i=2; i<numero; i++){ // declaro que i=2, por lo que simpre que "i" sea menor que "numero" le sumo "1"
if (numero % i === 0) return false}  //si la division entre "numero" y "i"da 0 retorno falso
return true
...
function tieneTresDigitos(numero){
  var cadena= numero.toString() // cadena es igual a "numero" (convertido a string)
  if(cadena.length === 3){ // si el largo de cadena === 3 devolve true
  return true
}else{
  return false
}
...
function doWhile(numero) {
  ...
  do{suma= suma+5 
  i= i+1 } // aca suma 5
  while (i < 8) //aca pregunta si i es menor a 8 (si lo es suma 5, sino es poruqe ya cumplio su condicion)
return suma

   //Implementar una función tal que vaya aumentando el valor recibido en 5 hasta un límite de 8 veces
  //Retornar el valor final.
  //Usar el bucle do (hacer) while (consultar).
}
